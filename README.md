...
=== Актуализация EFI по состоянию на 25.05.2019 ===

**"EFI"** актуальна для систем: 10.12.6 | 10.13.6 | 10.14.5  **Clover v2.4k LastVers**

**"EFI on OpenCore"** актуальна для систем: 10.13.6 | 10.14.5 | 10.14.6 beta1 **OpenCore v.0.0.2**
